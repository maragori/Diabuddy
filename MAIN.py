...
from HELPER import Predictions
...
task = Task(monitor, assess, diagnose, base, predictions)
...
### TO DO
# implement ontology that extracts macro nutritions from food types (if we have time)
